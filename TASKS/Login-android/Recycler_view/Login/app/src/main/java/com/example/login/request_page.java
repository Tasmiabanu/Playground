...
public class request_page extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String titles[]={"PUR - 2019 - 056","PUR - 2019 - 056","PUR - 2019 - 056","PUR - 2019 - 056"};
        String dates[]={"06 Jul 2019","06 Jul 2019","06 Jul 2019","06 Jul 2019"};
        String textView16[]={"APPROVED","APPROVED","APPROVED","APPROVED"};
        list_adapter listAdapter= new list_adapter(getApplicationContext(), titles, dates, textView16);
