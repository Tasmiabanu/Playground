...
public class request_page extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String titles[]={"Rose","Lotus","Jasmine","RCB","Bengularu Bulls"};
        String dates[]={"22-Aug","24-Aug","28-Aug","30-Aug","2-Sep"};
        String status[]={"APPROVED","REJECTED","DRAFT","AWAITING","COMPLETED"};
        list_adapter listAdapter= new list_adapter(getApplicationContext(), titles, dates, status)
        {
            @Override
